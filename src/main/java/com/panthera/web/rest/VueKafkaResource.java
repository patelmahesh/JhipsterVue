...
@RestController
@RequestMapping("/api/vue-kafka")
public class VueKafkaResource {

    private final Logger log = LoggerFactory.getLogger(VueKafkaResource.class);
    ...
    public VueKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
